...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('aria_sistema.log'),
...
class AriaUniversal:
    ...
    def monitoreo_continuo(self, duracion_segundos: int = 60):
        ...
        self.logger.info(f"👁️ Iniciando monitoreo continuo por {duracion_segundos} segundos...")
...
def main():
    ...
    try:
        ...
        print("\n🎯 Ejecutando demostración de capacidades...")
